...
var instrucciones = ["Utilizar las flechas para mover las piezas", "Ordenar las piezas hasta alcanzar la imagen que se ve en la miniatura"];
...
function guardaMovimientos(direccion) {
...
function chequearSiGano() {
  var grillaAplastada = grilla.flat();
  for(var i=0;i<(grillaAplastada.length-1);i++) {
    if (grillaAplastada[i] > grillaAplastada[i+1]) {
        return false;
      }
    }
    return true;
...
function intercambiarPosicionesGrilla(filaPos1, columnaPos1, filaPos2, columnaPos2) {
    var guardarValor = grilla[filaPos1][columnaPos1];
    grilla[filaPos1][columnaPos1] = grilla[filaPos2][columnaPos2];
    grilla[filaPos2][columnaPos2] = guardarValor;
}
